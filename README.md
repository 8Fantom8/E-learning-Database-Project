...
As we used syndetically generalized data, you should first go to the data folder and run `data_pօpulation.py`, creating a folder called data filled with CSV files within the same path. >(If you have your data, please skip this step) Then follow the instructions in `README.txt` in `data_population`.
